        ...
        <div class="w-full xl:w-[500px] flex-none">
            <div class="flex flex-col gap-8 sm:gap-10 md:gap-10 bg-custom-light-yellow rounded-3xl p-8 sm:p-12 md:p-16 h-full text-paragraph" style="box-shadow: 10px 10px 20px 3px rgba(0, 0, 0, 0.25);">
                ...
                <div class="text-custom-darker-blue flex gap-4 sm:gap-6 md:gap-7 lg:gap-8">
                    <a href="https://www.instagram.com/automaticdoordutacitra" target="_blank" rel="noopener noreferrer" class="bg-custom-lighter-blue w-12 sm:w-14 md:w-[3.75rem] lg:w-16 aspect-square p-3 md:p-3.5 flex justify-center items-center rounded-full">
                    ...
                    <a href="mailto:dutacitranusajaya@gmail.com" target="_blank" rel="noopener noreferrer" class="bg-custom-lighter-blue w-12 sm:w-14 md:w-[3.75rem] lg:w-16 aspect-square p-3 md:p-3.5 flex justify-center items-center rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-full aspect-square" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z" />
                        </svg>
                    </a>
