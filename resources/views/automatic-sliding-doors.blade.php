...
<div class="c-container flex justify-center items-center py-16">
...
<div class="px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12 flex flex-col justify-center items-center gap-6 sm:gap-7 md:gap-8 pt-8 bg-custom-darker-blue text-custom-white">
    ...
    <div class="w-full">
        <div class="flex gap-4 sm:gap-6 md:gap-8 text-paragraph leading-none overflow-auto w-full pb-8">
            <span class="flex w-48 sm:w-56 md:w-64 xl:w-auto flex-none xl:flex-1 justify-center items-center text-center border border-custom-white rounded-full px-4 md:px-8 py-3 sm:py-3.5 md:py-4 cursor-pointer transition hover:bg-custom-light-blue hover:text-custom-dark-blue">Standard</span>
            <span class="flex w-48 sm:w-56 md:w-64 xl:w-auto flex-none xl:flex-1 justify-center items-center text-center border border-custom-white rounded-full px-4 md:px-8 py-3 sm:py-3.5 md:py-4 cursor-pointer transition hover:bg-custom-light-blue hover:text-custom-dark-blue">Telescopic</span>
            <span class="flex w-48 sm:w-56 md:w-64 xl:w-auto flex-none xl:flex-1 justify-center items-center text-center border border-custom-white rounded-full px-4 md:px-8 py-3 sm:py-3.5 md:py-4 cursor-pointer transition hover:bg-custom-light-blue hover:text-custom-dark-blue">Curved & Semicircular</span>
            <span class="flex w-48 sm:w-56 md:w-64 xl:w-auto flex-none xl:flex-1 justify-center items-center text-center border border-custom-white rounded-full px-4 md:px-8 py-3 sm:py-3.5 md:py-4 cursor-pointer transition hover:bg-custom-light-blue hover:text-custom-dark-blue">Hermetic</span>
            <span class="flex w-48 sm:w-56 md:w-64 xl:w-auto flex-none xl:flex-1 justify-center items-center text-center border border-custom-white rounded-full px-4 md:px-8 py-3 sm:py-3.5 md:py-4 cursor-pointer transition hover:bg-custom-light-blue hover:text-custom-dark-blue">Panic Break Out</span>
            <span class="flex w-48 sm:w-56 md:w-64 xl:w-auto flex-none xl:flex-1 justify-center items-center text-center border border-custom-white rounded-full px-4 md:px-8 py-3 sm:py-3.5 md:py-4 cursor-pointer transition hover:bg-custom-light-blue hover:text-custom-dark-blue">Fire Resistant</span>
        </div>
    </div>
</div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-1 flex flex-col gap-3">
                            ...
                            <div class="flex items-center gap-4">
                                <img src="{{asset('assets/product/biparting-icon.png')}}" alt="bi-parting" class="flex-none aspect-square">
                        ...
                        <div class="col-span-1 flex flex-col gap-3">
                            ...
                            <div class="flex items-center gap-4">
                                <img src="{{asset('assets/product/single-icon.png')}}" alt="single" class="flex-none aspect-square">
