            ...
            <div class="flex flex-col gap-8 md:items-end justify-between col-span-2 md:col-span-1">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="text-custom-darker-blue flex gap-4 sm:gap-6 md:gap-7 lg:gap-8">
                        ...
                        <a href="https://www.tiktok.com/@automaticdoordutacitra" target="_blank" rel="noopener noreferrer" class="bg-custom-white w-12 sm:w-14 md:w-[3.75rem] lg:w-16 aspect-square p-3 md:p-3.5 flex justify-center items-center rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-full aspect-square" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z" />
                            </svg>
                        </a>

                        <a href="https://www.youtube.com/@automaticdoordutacitra" target="_blank" rel="noopener noreferrer" class="bg-custom-white w-12 sm:w-14 md:w-[3.75rem] lg:w-16 aspect-square p-3 md:p-3.5 flex justify-center items-center rounded-full">
