    ...
    <div class="grid gap-16 grid-cols-1 xl:grid-cols-9">
        <div class="flex flex-col gap-4 col-span-1 xl:col-span-3">
            ...
            <div class="flex items-center gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 sm:w-7 md:w-8 aspect-square flex-none" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="flex items-center gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 sm:w-7 md:w-8 aspect-square" fill="currentColor" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
                </svg>
                <p class="text-custom-white/70">+62 811 8869677</p>
            </div>
        ...
        <div class="col-span-1 xl:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-16 xl:ml-16 2xl:ml-32">
            ...
            {{-- FOLLOW US --}}
            <div class="flex flex-col gap-12 md:items-end justify-between col-span-2 md:col-span-1">
                <div class="flex flex-col gap-4">
                    <h1 class="md:text-end font-semibold text-paragraph">FOLLOW US</h1>

                    <div class="text-custom-darker-blue flex gap-4 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8">
                        <a href="https://www.instagram.com/automaticdoordutacitra" target="_blank" rel="noopener noreferrer" class="bg-custom-white w-12 sm:w-[3.25rem] md:w-14 lg:w-[3.75rem] xl:w-16 aspect-square flex justify-center items-center rounded-full border-white border hover:bg-transparent hover:text-custom-white transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 sm:w-[1.625rem] md:w-7 lg:[1.875rem] xl:w-8 aspect-square" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <a href="https://www.tiktok.com/@automaticdoordutacitra" target="_blank" rel="noopener noreferrer" class="bg-custom-white w-12 sm:w-[3.25rem] md:w-14 lg:w-[3.75rem] xl:w-16 aspect-square flex justify-center items-center rounded-full border-white border hover:bg-transparent hover:text-custom-white transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 sm:w-[1.625rem] md:w-7 lg:[1.875rem] xl:w-8 aspect-square" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z" />
                            </svg>
                        </a>

                        <a href="https://www.youtube.com/@automaticdoordutacitra" target="_blank" rel="noopener noreferrer" class="bg-custom-white w-12 sm:w-[3.25rem] md:w-14 lg:w-[3.75rem] xl:w-16 aspect-square flex justify-center items-center rounded-full border-white border hover:bg-transparent hover:text-custom-white transition">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 sm:w-[1.625rem] md:w-7 lg:[1.875rem] xl:w-8 aspect-square" viewBox="0 0 16 16">
                ...
                <div>
                    <a href="https://www.manusa.com/" target="_blank" rel="noopener noreferrer">
