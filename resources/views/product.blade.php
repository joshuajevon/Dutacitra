...
<div class="header" style="background-image: url({{asset('assets/header/product-header.jpg')}}?t={{ env('VERSION_TIME') }});">
    <h1 class="font-ttRamillas text-center font-extrabold">
        Our Product
    </h1>
</div>
...
<div class="c-container text-paragraph pb-8 sm:pb-12 md:pb-16 pt-6 sm:pt-8 md:pt-10 flex flex-col gap-6 sm:gap-7 md:gap-8 justify-center items-center">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 w-full gap-4 sm:gap-5 md:gap-6 text-custom-darker-blue">
        <a href="{{ route('automaticSlidingDoors', ['lang' => $lang]) }}" class="flex flex-col gap-2.5 sm:gap-3 md:gap-4 overflow-hidden">
        ...
        <a href="{{ route('automaticSwingDoors', ['lang' => $lang]) }}" class="flex flex-col gap-2.5 sm:gap-3 md:gap-4 overflow-hidden">
            <div class="h-[300px] sm:[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] overflow-hidden">
        ...
        <a href="{{ route('automaticRevolvingDoors', ['lang' => $lang]) }}" class="flex flex-col gap-2.5 sm:gap-3 md:gap-4 overflow-hidden">
            <div class="h-[300px] sm:[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] overflow-hidden">
        ...
        <a href="{{ route('automaticHermeticDoors', ['lang' => $lang]) }}" class="flex flex-col gap-2.5 sm:gap-3 md:gap-4 overflow-hidden">
            <div class="h-[300px] sm:[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] overflow-hidden">
