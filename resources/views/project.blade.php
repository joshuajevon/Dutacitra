...
<div class="h-24 sm:h-28 md:h-32 lg:h-40 xl:h-48 bg-center bg-cover flex items-center justify-center" style="background-image: url({{asset('assets/project/header.jpg')}});">
