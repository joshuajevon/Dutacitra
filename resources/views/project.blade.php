...
@section('body')
    ...
    <div class="h-32 sm:h-56 md:h-64 lg:h-72 xl:h-80 bg-center bg-cover flex items-center justify-center" style="background-image: url({{asset('assets/project/header.jpg')}});">
    ...
    <div class="c-container text-paragraph py-16 sm:py-24 md:py-32 flex flex-col gap-8">
        <div class="bg-custom-lighter-blue px-8 pt-6 pb-3 relative">
        ...
        <div class="bg-custom-lighter-blue px-8 pt-6 pb-3 relative mt-16">
